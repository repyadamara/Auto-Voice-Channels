...
def start_bot_cluster(
        token: str,                 # Bot token
        cluster_id: int,            # Cluster Id - Keeps us stateful
        total_shards: int,          # Total amount of shards - Needed for the bot.
        shards: typing.List[int],   # list of shard Ids from a range - Needed for the bot.
        *args,
        **kwargs
):
